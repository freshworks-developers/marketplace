 ...
 * Run automatically by e2e.sh, or manually: node tests/e2e/e2e-report.js
 */
...
<body>
  <div class="container">
    ...
    <footer>Generated by <code>./tests/e2e/e2e.sh</code> · output dir: <code>${outputDir}</code></footer>
  </div>
</body>
</html>
`;
