...
Property: `autoFocusOnContent`
Attribute: `auto-focus-on-content`
Description: Whether to focus on the element in popover-content slot on opening the dropdown.
Type: `boolean`
Default: `false`
...
Property: `boundary`
Attribute: --
Description: The area that the popup will be checked for overflow relative to.
Type: `HTMLElement`
Default: `undefined`
...
Description: Option to disable the popover animation on hide and show.
Type: `boolean`
Default: `false`
...
Description: Option to determine if popover-content has a border.
Type: `boolean`
Default: `true`
...
Description: Indicates the delay after which popover will be hidden.
Type: `number`
Default: `0`
...
Description: Indicates whether popover contents should be hidden on pressing Tab.
Type: `boolean`
Default: `true`
...
Description: Whether the popover-content width to be same as that of the popover-trigger.
Type: `boolean`
Default: `true`
...
Description: Indicates the delay after which popover will be shown.
Type: `number`
Default: `0`
...
Property: `skidding`
Attribute: `skidding`
Description: Skidding defines the distance between the popover trigger and the popover content along x-axis.
Type: `string`
Default: `'0'`
...
Property: `variant`
Attribute: `variant`
Description: Variant defines the style of the popover-content.
...
Event: `fwHide`
Description: Triggered whenever the popover contents is closed/hidden.
Type: `CustomEvent<any>`


Event: `fwShow`
Description: Triggered whenever the popover contents is open/displayed.
Type: `CustomEvent<any>`
---
...
Description: border radius of the popover content.


Name: `--fw-popover-box-shadow`
Description: box shadow of the popover content.


Name: `--fw-popover-max-height`
Description: Maximum height of the popover content.
...
Description: Minimum height of the popover content.
