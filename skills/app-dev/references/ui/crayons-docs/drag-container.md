...
Description: Id of the fw-sortable element from which draggable content can be accepted. Add comma separated id's for multiple containers.
Type: `string`
Default: `''`
...
Description: Whether the drag element should be added to the container on drop. If set to false, the placeholder will be retained.
Type: `boolean`
Default: `true`
...
Property: `copy`
Attribute: `copy`
Description: Whether the drag element should be moved or copied.
Type: `boolean`
Default: `true`
...
Description: The class name for the drag/drop placeholder. Add space separated class names for multiple classes
Type: `string`
Default: `''`
...
Property: `sortable`
Attribute: `sortable`
Description: Whether the list should be sortable.
Type: `boolean`
Default: `true`
---
...
Event: `fwDragEnter`
Description: Triggered when a draggable item enters the container.
Type: `CustomEvent<void>`


Event: `fwDragLeave`
Description: Triggered when a draggable item leaves the container.
Type: `CustomEvent<void>`


Event: `fwDrop`
Description: Triggered when a draggable item is dropped inside the container.
Type: `CustomEvent<void>`
---
