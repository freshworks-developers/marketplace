...
Property: `easing`
Attribute: `easing`
Description: Adjust animation settings using easing (a CSS easing string). Default is `ease`
Type: `string`
Default: `'ease'`
...
Property: `minimum`
Attribute: `minimum`
Description: Changes the minimum percentage used upon starting. Default is `0.08`
Type: `number`
Default: `0.08`
...
Property: `parent`
Attribute: `parent`
Description: Specify a selector to change the parent container. Default is `body` Selector is accessed internally via document.querySelector method
Type: `string`
Default: `'body'`
...
Property: `show`
Attribute: `show`
Description: Show progress loader. Default `false`
Type: `boolean`
Default: `false`
...
Property: `speed`
Attribute: `speed`
Description: Add speed (in ms). Default is `200`
Type: `number`
Default: `200`
...
Property: `template`
Attribute: `template`
Description: Use Custom markup. To keep the progress bar working, keep an element with class='bar' in there
Type: `string`
...
Property: `trickle`
Attribute: `trickle`
Description: Turn on/off the automatic incrementing behavior by setting this to false. Default is `true`
Type: `boolean`
Default: `true`
...
Description: Adjust how often to trickle/increment, in ms. Default is `200`
Type: `number`
Default: `200`
---
