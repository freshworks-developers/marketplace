...
<p align="center">100% automated FDK lifecycle management for macOS and Windows.<br>Install, upgrade, downgrade, and uninstall FDK using <strong>subagents</strong> with <strong>nvm</strong> and <strong>Node.js 24</strong>.</p>

<p align="center"><code>Subagent-Based</code> · <code>nvm</code> · <code>Node.js 24</code> · <code>Multi-Version Support</code> · <code>Autonomous Execution</code></p>
...
**Slash Commands:**
```bash
/fdk-setup install              # Install FDK with Node.js 24 via nvm
...
3. **Installs Node.js 24** - Latest 24.x via nvm (keeps other versions)
...
**References:**
- `macos.md` - nvm + Node.js 24 + FDK setup for macOS
- `windows.md` - nvm-windows + Node.js 24 + FDK setup for Windows

**Key Features:**
- **nvm Integration** - Manages Node.js 24 alongside other versions
- **Version Isolation** - FDK uses Node 24, other projects use their versions
...
- **Node.js 24.13.0+** (installed automatically via nvm)
