...
- **Node.js v24.0.0 or later** — Installed via nvm-windows
...
Ensure version is 10.0.0 or later (recommended for Platform 3.0).
...
nvm use 24          # Use Node 24 for FDK
nvm use 20          # Use Node 20 for other projects

# Set default version (optional)
nvm use 24          # Sets as current for new terminals
```
...
- Always use Node.js 24 for FDK: `nvm use 24`
