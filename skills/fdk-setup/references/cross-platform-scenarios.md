...
/fdk-setup-install --both

# Or separately:
/fdk-setup-install          # FDK 10.x on Node 24
/fdk-setup-downgrade        # FDK 9.x on Node 18 (if needed)

# Switch between them:
/fdk-setup-use 10           # Current shell only
/fdk-setup-use 10 --global  # All new shells
```
...
|--------|-------------------|----------------|-------|
| **nvm** | ✅ Yes (per Node version) | `nvm use 24.11` or `/fdk-setup-use 10` | Per-shell or global |
...
| `/fdk-setup-use 10` | ✅ Changed | ❌ Unchanged | No |
| `/fdk-setup-use 10 --global` | ✅ Changed | ✅ Changed | Yes (updates .zshrc/.bashrc) |
