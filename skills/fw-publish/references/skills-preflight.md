...
| ID | Question | Skills |
|----|----------|--------|
| **Q1** | **Which app folder?** — folder with **`manifest.json`** (one hit → use; several → ask). | fw-app-dev, fw-publish, fw-review, fw-ai-actions-app* |
...
\* **Q1** for **fw-ai-actions-app**: implicit project root today — align with app-dev **Q1** in **`SKILL.md`** (see **`AGENTS.md`** skill id **fw-ai-actions-app**).
...
| **fw-ai-actions-app** | Implicit root | — | — | **fdk validate** path |
...
- **fw-ai-actions-app** — **`SKILL.md`**: same logic as **fw-app-dev** *(today: implicit root only; align with **`AGENTS.md`**)*.
