...
- If **fw-setup** is missing: prompt the user to add it (e.g. `npx skills add https://github.com/freshworks-developers/marketplace --skill fw-setup`, or copy `skills/fw-setup/` from this repo), then continue Step 0.
