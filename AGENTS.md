...
| **fw-ai-actions-skill** | `skills/fw-ai-actions-skill/SKILL.md` | Standalone **AI Actions** skill: same problem domain as **fw-ai-app-dev**, packaged for `npx skills add --skill fw-ai-actions-skill`, with **agents/** prompts (scoper, implementer, validator). Use **fw-ai-app-dev** for templates/scripts under that skill tree; use this entry when the user installed the standalone skill. |
...
| Same as above, user or project uses **standalone** `fw-ai-actions-skill` install | `skills/fw-ai-actions-skill/SKILL.md` | Same constraints; follow this file’s **agents/** when running scoper / implementer / validator flows |
...
- **`skills/{fw-app-dev|fw-ai-app-dev|fw-ai-actions-skill|fw-review|fw-setup|fw-publish}/SKILL.md`** — skill entry and frontmatter
...
### fw-ai-actions-skill — `skills/fw-ai-actions-skill/`
